...
public class PageLoginDataBinding {
    ...
    public String getUsername(){
        return Objects.requireNonNull(loginObservableField.get()).getUsername();
    }

    public String getPassword(){
        return Objects.requireNonNull(loginObservableField.get()).getPassword();
    }

    public void setUsername(String username){
        Objects.requireNonNull(loginObservableField.get()).setUsername(username);
    }

    public void setPassword(String password){
        Objects.requireNonNull(loginObservableField.get()).setPassword(password);
    }
